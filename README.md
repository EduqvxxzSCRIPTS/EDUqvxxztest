...
local Window = OrionLib:MakeWindow({Name = "eduqvxxzHub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "eduqvxxzHub"})
...
W:AddLabel("[+] eduqvxxzHub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "eduqvxxzHub(Noitification)",
